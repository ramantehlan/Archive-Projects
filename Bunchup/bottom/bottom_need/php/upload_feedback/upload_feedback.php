...
{
	mysql_select_db($db_name);
	$code="INSERT INTO `feedback_upload` (`no`, `user_no`, `feedback_of_user`, `date_of_feedback`, `month_of_feedback`, `year_of_feedback`, `ip_address`) VALUES (NULL, '$user_no', '$message', '$t_date', '$t_month', '$t_year', '$v_ip');";
	 mysql_query($code);
	echo "<div class='right_side_meassage_dear_one'>Dear user your form have been uploaded successfully</div>";
}
else
...
{
	 echo "<div class='right_side_meassage_dear_one'>Sorry some technical error occurred.</div>";
}
